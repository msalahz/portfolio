          ...
          <div className="pt-12 pb-20 sm:pt-0 md:pb-20 lg:pt-44 lg:pb-45">
            <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
              <div className="mx-auto max-w-lg text-center lg:ml-0 lg:w-1/2 lg:text-left">
                <p className="text-muted-foreground mt-8 text-sm font-medium tracking-widest uppercase lg:mt-16">
                  Hello, I'm
                </p>

                <h1 className="max-w-4xl text-5xl font-medium md:text-6xl xl:text-7xl">
                  Mohammed Zaghloul
                </h1>
                <p className="text-primary mt-4 text-lg font-medium lg:text-xl">
                ...
                <div className="mt-12 flex flex-col items-center justify-center gap-5 sm:flex-row lg:justify-start">
              ...
              <div className="-z-10 order-first ml-auto w-full object-cover lg:absolute lg:inset-0 lg:-top-65 lg:-right-20 lg:order-last lg:h-max lg:w-2/3 lg:object-contain dark:mix-blend-lighten dark:invert-0">
                <HeroHeadshot />
              </div>
            </div>
          </div>
